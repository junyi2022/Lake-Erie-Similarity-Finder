...
function updatePercentageDisplay(percentageDisplay) {
    percentageDisplay.textContent = `${fromInput.value}% - ${toInput.value}%`;
}
...
function controlFromInput(fromSlider, fromInput, toInput, toSlider) {
    ...
    updatePercentageDisplay(percentageDisplay);
}
...
function displaySelectPointScoreOnRange(score) {
  scoreLabel.innerHTML = `<div id="select-point-box-text" class="select-point-box-pop">Selected Point Score: ${score}</div>`;
